        ...
        <div className="col-md-8">
          <div className="row mb-3">
            <div className="col-md-5 text-center">
              <img
                src="../../images/products/table1.jpg"
                className="img-fluid mb-3"
                with="80"
                alt=""
              />
              <img
                src="../../images/products/table2.jpg"
                className="border border-secondary me-2"
                width="80"
                alt="..."
              />
              <img
                src="../../images/products/table3.jpg"
                className="border border-secondary me-2"
                width="75"
                alt="..."
              />
            ...
            <div className="col-md-7">
              <h1 className="h5 d-inline me-2">Item  name goes here</h1>
              ...
              <dl className="row small mb-3">
                ...
                <dt className="col-sm-3">Rental  by</dt>
                <dd className="col-sm-9">Authorised Store</dd>
                <dt className="col-sm-3">Demensions</dt>
              ...
              <div>
                <p className="fw-bold mb-2 small">Item Highlights</p>
                <ul className="small">
                  <li>

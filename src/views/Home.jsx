    ...
    return (
      <React.Fragment>
        ...
        <div className="container-fluid bg-light mb-3">
          <div className="row g-3">
            ...
            <div className="col-md-3">
              ...
              <CardImage
                src="../../images/banner/camera_banner.jpg"
                to="promo"
              />
            </div>
          </div>
        ...
        <div className="bg-info bg-gradient p-3 text-center mb-3">
          <h4 className="m-0">Explore Our Itmes </h4>
        </div>
          ...
          <div className="row">
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                  src="../../images/category/cam4.jpg"
                  className="img-fluid ascpect-ratio-1x1 mx-auto"
                  alt="camera"
                />
                <div className="text-center h6"> HD Cameras </div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                  src="../../images/category/birth_category.jpg"
                  className="img-fluid mx -auto "
                  alt="birthday"
                />
                <div className="text-center h6">Birthday Decorations</div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                  src="../../images/category/wedding_category.jpg"
                  className="img-fluid  mx-auto"
                  alt="weddimg"
                />
                <div className="text-center h6">Wedding Decorations</div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                  src="../../images/category/gradu_category.jpg"
                  className="img-fluid ascpect-ratio-1x1 mx-auto"
                  alt="graduation"
                />
                <div className="text-center h6">Graduation ceremony </div>
              </Link>
            </div>
          </div>
        </div>

  ...
  return (
    <div>
      <div className="bg-secondary border-top p-4 text-white mb-3">
        <h1 className="display-6">Booking  Cart</h1>
      </div>
            ...
            <div className="card">
                      ...
                      <td>
                        <div className="row">
                          <div className="col-3 d-none d-md-block">
                            <img
                              src="../../images/products/table4.jpg"
                              width="80"
                              alt="..."
                            />
                          </div>
                          <div className="col">
                            ...
                            >
                             big table that can be used in food serving and other purposes
                            </Link>
                            <p className="small text-muted">
                              Demensions : WXL ,height 1.5 m
                            </p>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div className="row">
                          <div className="col-3 d-none d-md-block">
                            <img
                              src="../../images/products/chair3.jpg"
                              width="80"
                              alt="..."
                            />
                          </div>
                          <div className="col">
                            <Link
                              ...
                              className="text-decoration-none"
                            >
                              Single seat chair with cushion
                            </Link>
                            <p className="small text-muted">
                              Demensions: WXL , height 1.5m
                            </p>
                          </div>
                        </div>
                      </td>
              ...
              <div className="card-footer">
                <Link to="/checkout" className="btn btn-primary float-end">
                  Book More  <i className="bi bi-chevron-right"></i>
                </Link>
                <Link to="/" className="btn btn-secondary">
                  <i className="bi bi-chevron-left"></i> Continue Booking
                </Link>
              </div>
            </div>
            <div className="alert alert-success mt-3">
              <p className="m-0">
                <i className="bi bi-truck"></i> Free Delivery within 24/7
              </p>
            </div>
          </div>
